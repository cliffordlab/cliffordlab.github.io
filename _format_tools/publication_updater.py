...
def main():
    ...
    journals("publication_info/data/JOURNALS.txt", "../pages/test_publications.html")
    reviews_editorials("publication_info/data/REVIEWS_EDITORIALS.txt", "../pages/test_publications.html")
    conferences("publication_info/data/CONFERENCES.txt", "../pages/test_publications.html")
    books_chapters("publication_info/data/BOOKS_CHAPTERS.txt", "../pages/test_publications.html")
    other_material("publication_info/data/MATERIAL.txt", "../pages/test_publications.html")
    theses("publication_info/data/THESES.txt", "../pages/test_publications.html")
